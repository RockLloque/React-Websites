...
var IndecisionApp = function (_React$Component) {
  ...
  _createClass(IndecisionApp, [{
    ...
    value: function handlePick() {
      var opt = this.state.options[Math.floor(Math.random() * this.state.options.length)];
      alert(opt);
    }
  }, {
    key: "handleAddOption",
    value: function handleAddOption(option) {
      if (!option) {
        ...
        this.setState(function (oldState) {
          return {
            options: [].concat(_toConsumableArray(oldState.options), [option])
          };
        });
      }
    }
    ...
    value: function handleDeleteOptionSingular(optionToRemove) {
      this.setState(function (oldState) {
        return {
          options: oldState.options.filter(function (option) {
    ...
    value: function render() {
      ...
      var subtitle = "Use Computer what do?";
    ...
    value: function render() {
      return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement("input", { id: "addOption", type: "text", name: "addOption" }),
          React.createElement(
            "button",
            null,
            "Add option"
